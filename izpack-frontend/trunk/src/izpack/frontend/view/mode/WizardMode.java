/*
 * Created on Jul 3, 2004 $Id: Wizard.java Feb 8, 2004 izpack-frontend Copyright
 * (C) 2001-2003 IzPack Development Group File : Wizard.java Description : TODO
 * Add description Author's email : gumbo@users.berlios.de This program is free
